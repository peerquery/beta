...
module.exports = function(app) {
    ...
    var siteSitemap = sm.createSitemap({
        ...
        urls: [
            ...
            { url: '/support/faqs', changefreq: 'monthly', priority: 0.7 },
            { url: '/support/contact', changefreq: 'monthly', priority: 0.7 },
            { url: '/curation', changefreq: 'daily', priority: 0.7 },
            { url: '/open-source', changefreq: 'monthly', priority: 0.7 },
            { url: '/statistics', changefreq: 'daily', priority: 0.7 },
            ...
            { url: '/steem', changefreq: 'daily', priority: 0.7 },
